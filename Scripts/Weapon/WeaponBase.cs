...
public class WeaponBase : MonoBehaviour {
	...
	void StartReload() {
		if(isReloading ||
			loadedBullets >= bulletsPerMag + (upgradeMagFactor * (float) upgradeMag) || 
	...
	void RefillAmmunitions() {
		int bulletsToLoad = (bulletsPerMag + ((int) upgradeMagFactor * upgradeMag)) - loadedBullets;
